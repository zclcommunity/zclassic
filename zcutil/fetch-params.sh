...
if [[ "$OSTYPE" == "darwin"* ]]; then
    PARAMS_DIR="$HOME/Library/Application Support/ZclassicParams"
else
...
Failed to fetch the Zclassic zkSNARK parameters!
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Zclassic zkSNARK parameters. Note that it is
