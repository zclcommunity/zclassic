...
installation for use as a Buildbot worker in Zclassic's CI.
...
2. Start a basic EC2 instance using the template AMI for the target OS.
  - Choose the smallest instance size, it won't be used for building Zclassic.
