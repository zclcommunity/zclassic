...
If this is a hotfix release, please see the [Hotfix Release Process](https://github.com/zclassic/zclassic/blob/master/doc/hotfix-process.md) documentation before proceeding.
...
Push the resulting branch to github:
    ...
    $ git push 'git@github.com:$YOUR_GITHUB_NAME/zclassic' $(git rev-parse --abbrev-ref HEAD)
...
- Run the [Gitian deterministic build environment](https://github.com/zclassic/zclassic-gitian)
- Compare the uploaded [build manifests on gitian.sigs](https://github.com/zclassic/gitian.sigs)
- If all is well, the DevOps engineer will build the Debian packages and update the
  [apt.z.cash package repository](https://apt.z.cash).

## Add release notes to GitHub

- Go to the [GitHub tags page](https://github.com/zclassic/zclassic/tags).
...
Notify the Zclassic DevOps engineer/sysadmin that the release has been tagged. They update some variables in the company's automation code and then run an Ansible playbook, which:

* builds Zclassic based on the specified branch
...
This also means updating [the translations](https://github.com/zclassic/zclassic-docs).
Coordinate with the translation team for now. Suggestions for improving this
part of the process should be added to #2596.

### Publish the release announcement (blog, github, zclassic-dev, slack)
