...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to zclassicd by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for zclassicd -help.
...
Jack Grigg (25):
      ...
      Add libevent to zclassic-gtest
...
Jay Graber (5):
      ...
      Add security warning to zclassic-cli --help and --version message output
      Add security warning to zclassicd metrics display
