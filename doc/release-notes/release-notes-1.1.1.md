...
in [ZIP 243](https://github.com/zclassic/zips/blob/master/zip-0243.rst) and the
[Sapling spec](https://github.com/zclassic/zips/blob/master/protocol/sapling.pdf)
...
`zclassic-fetch-params --testnet` (for binary / Debian users).
...
Jack Grigg (55):
      Disable building libzclassicconsensus by default
      ...
      [Bitcoin-Tx] Adjust util-test test cases for Zclassic
      Handle usage of prevector for CScript in Zclassic-specific code
      GetSerializeSize changes in Zclassic-specific code
      Remove nType and nVersion from Zclassic-specific code
      ...
      Use CBitcoinAddress wrappers in Zclassic-specific code
      ...
      Add key_io includes to Zclassic-specific code
...
Larry Ruane (1):
      fix qa/zclassic/full_test_suite.py pathname
...
Simon Liu (18):
      ...
      Refactoring: libzclassic::Note is now a subclass of libzclassic::BaseNote.
      Refactoring: Rename class libzclassic::Note to libzclassic::SproutNote.
