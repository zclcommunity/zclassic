...
Jack Grigg (24):
      ...
      Handle full Zclassic version string in AC_INIT
...
Sean Bowe (28):
      ...
      Use base58check to encode Zclassic payment addresses, such that the first two bytes are "zc".
      Add tests for `CZCPaymentAddress`.
      Fix test against merkle tree root.
      Added encoding for Zclassic spending keys.
