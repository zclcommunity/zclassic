...
Alfie John (1):
      Rename libzerocash to libzclassic
...
Jack Grigg (21):
      ...
      Add Zclassic revision to version strings
      Bitcoin -> Zclassic in version and help text
      Add Zclassic Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-zclassic`` correctly runs the ``zclassic-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the Zclassic build.
