...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "Zclassic" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pzclassicParams with private member variable
      Revert "Reduce use of global pzclassicParams with private member variable"
      Replace zclassicParams_ with global.
