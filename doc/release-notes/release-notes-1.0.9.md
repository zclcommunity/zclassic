...
Jack Grigg (14):
      ...
      Convert Zclassic versions to Debian format
      ...
      Implement automatic shutdown of deprecated Zclassic versions
...
Jay Graber (2):
      Change help text examples to use Zclassic addresses
...
Nathan Wilcox (39):
      ...
      Add all of the zclassic release tags in my current repo as positive test vector.
      ...
      Reuse zclassic_rpc.
      Do not use `-rpcwait` on all `zclassic_rpc` invocations, only block when starting zclassicd.
...
emilrus (1):
      Replace bitcoind with zclassicd
