...
Jack Grigg (31):
      ...
      Rename libbitcoinconsensus to libzclassicconsensus
      Rename bitcoin-tx to zclassic-tx
...
Jay Graber (7):
      Rm bitcoin dev keys from gitian-downloader, add zclassic dev keys
      Rm bips.md
      Update files.md for zclassic
