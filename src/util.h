...
#endif
class missing_zclassic_conf : public std::runtime_error {
public:
    missing_zclassic_conf() : std::runtime_error("Missing zclassic.conf") { }
};
...
{
    std::string s = strprintf("zclassic-%s", name);
