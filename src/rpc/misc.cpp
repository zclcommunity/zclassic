...
{
public:
    UniValue operator()(const libzclassic::InvalidEncoding &zaddr) const { return UniValue(UniValue::VOBJ); }

    UniValue operator()(const libzclassic::SproutPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
    ...
    UniValue operator()(const libzclassic::SaplingPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
