...
TEST(keystore_tests, sapling_keys) {
    ...
    for (size_t i = 2; i < 12; i++) {
        ...
        libzclassic::diversifier_t default_d;
        ...
        auto sk = libzclassic::SaplingSpendingKey(skSeed);
        
        // Check that expanded spending key from primitives and from sk are the same
        auto exp_sk_2 = libzclassic::SaplingExpandedSpendingKey(ask, nsk, ovk);
        ...
        auto full_viewing_key_2 = libzclassic::SaplingFullViewingKey(ak, nk, ovk);
        ...
        auto in_viewing_key_2 = libzclassic::SaplingIncomingViewingKey(ivk);
        ...
        auto default_addr_3 = libzclassic::SaplingPaymentAddress(default_d, default_pk_d);
...
TEST(keystore_tests, store_and_retrieve_spending_key) {
    CBasicKeyStore keyStore;
    libzclassic::SproutSpendingKey skOut;

    std::set<libzclassic::SproutPaymentAddress> addrs;
...
TEST(keystore_tests, StoreAndRetrieveViewingKey) {
    CBasicKeyStore keyStore;
    libzclassic::SproutViewingKey vkOut;
    libzclassic::SproutSpendingKey skOut;
    ZCNoteDecryption decOut;
...
TEST(keystore_tests, StoreAndRetrieveSaplingSpendingKey) {
    CBasicKeyStore keyStore;
    libzclassic::SaplingExtendedSpendingKey skOut;
    libzclassic::SaplingFullViewingKey fvkOut;
    libzclassic::SaplingIncomingViewingKey ivkOut;
...
TEST(keystore_tests, StoreAndRetrieveHDSeedInEncryptedStore) {
    ...
    ASSERT_TRUE(keyStore2.AddSproutSpendingKey(libzclassic::SproutSpendingKey::random()));
...
TEST(keystore_tests, store_and_retrieve_spending_key_in_encrypted_store) {
    ...
    libzclassic::SproutSpendingKey keyOut;
    ZCNoteDecryption decOut;
    std::set<libzclassic::SproutPaymentAddress> addrs;
