                      ...
                      libzclassic::ProofVerifier& verifier)
{
    ...
    if (!CheckTransactionWithoutProofVerification(tx, state)) {
        ...
        BOOST_FOREACH(const JSDescription &joinsplit, tx.vjoinsplit) {
            if (!joinsplit.Verify(*pzclassicParams, verifier, tx.joinSplitPubKey)) {
...
void ThreadScriptCheck() {
    RenameThread("zclassic-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    auto verifier = libzclassic::ProofVerifier::Strict();
    auto disabledVerifier = libzclassic::ProofVerifier::Disabled();
    ...
    const CChainParams& chainparams, CBlockIndex * const pindexPrev)
{
    ...
    // block didn't include the height in the coinbase (see Zclassic protocol spec
...
static bool AcceptBlock(const CBlock& block, CValidationState& state, const CChainParams& chainparams, CBlockIndex** ppindex, bool fRequested, CDiskBlockPos* dbp)
{
    ...
    auto verifier = libzclassic::ProofVerifier::Disabled();
