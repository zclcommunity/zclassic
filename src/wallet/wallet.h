...
{
public:
    libzclassic::SproutPaymentAddress address;
    ...
    SproutNoteData(libzclassic::SproutPaymentAddress a) :
            address {a}, nullifier(), witnessHeight {-1} { }
    SproutNoteData(libzclassic::SproutPaymentAddress a, uint256 n) :
...
public:
    ...
    SaplingNoteData(libzclassic::SaplingIncomingViewingKey ivk) : ivk {ivk}, witnessHeight {-1}, nullifier() { }
    SaplingNoteData(libzclassic::SaplingIncomingViewingKey ivk, uint256 n) : ivk {ivk}, witnessHeight {-1}, nullifier(n) { }
...
{
    SaplingOutPoint op;
    libzclassic::SaplingPaymentAddress address;
...
public:
    ...
    std::map<libzclassic::SproutPaymentAddress, CKeyMetadata> mapSproutZKeyMetadata;
    std::map<libzclassic::SaplingIncomingViewingKey, CKeyMetadata> mapSaplingZKeyMetadata;
    ...
    libzclassic::SproutPaymentAddress GenerateNewSproutZKey();
    //! Adds spending key to the store, and saves it to disk
    bool AddSproutZKey(const libzclassic::SproutSpendingKey &key);
    //! Adds spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadZKey(const libzclassic::SproutSpendingKey &key);
    //! Load spending key metadata (used by LoadWallet)
    bool LoadZKeyMetadata(const libzclassic::SproutPaymentAddress &addr, const CKeyMetadata &meta);
    //! Adds an encrypted spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadCryptedZKey(const libzclassic::SproutPaymentAddress &addr, const libzclassic::ReceivingKey &rk, const std::vector<unsigned char> &vchCryptedSecret);
    ...
    bool AddSproutViewingKey(const libzclassic::SproutViewingKey &vk);
    bool RemoveSproutViewingKey(const libzclassic::SproutViewingKey &vk);
    //! Adds a Sprout viewing key to the store, without saving it to disk (used by LoadWallet)
    bool LoadSproutViewingKey(const libzclassic::SproutViewingKey &dest);

    /**
      * Sapling ZKeys
      */
    //! Generates new Sapling key
    libzclassic::SaplingPaymentAddress GenerateNewSaplingZKey();
    //! Adds Sapling spending key to the store, and saves it to disk
    bool AddSaplingZKey(
        const libzclassic::SaplingExtendedSpendingKey &key,
    ...
    bool AddCryptedSaplingSpendingKey(
        ...
        const libzclassic::SaplingPaymentAddress &defaultAddr);
    //! Adds spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadSaplingZKey(const libzclassic::SaplingExtendedSpendingKey &key);
    //! Load spending key metadata (used by LoadWallet)
    bool LoadSaplingZKeyMetadata(const libzclassic::SaplingIncomingViewingKey &ivk, const CKeyMetadata &meta);
    ...
    bool LoadSaplingPaymentAddress(
        ...
        const libzclassic::SaplingIncomingViewingKey &ivk);
    //! Adds an encrypted spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadCryptedSaplingZKey(const libzclassic::SaplingExtendedFullViewingKey &extfvk,
                                const std::vector<unsigned char> &vchCryptedSecret);
    ...
    std::set<std::pair<libzclassic::PaymentAddress, uint256>> GetNullifiersForAddresses(const std::set<libzclassic::PaymentAddress> & addresses);
    bool IsNoteSproutChange(const std::set<std::pair<libzclassic::PaymentAddress, uint256>> & nullifierSet, const libzclassic::PaymentAddress & address, const JSOutPoint & entry);
    bool IsNoteSaplingChange(const std::set<std::pair<libzclassic::PaymentAddress, uint256>> & nullifierSet, const libzclassic::PaymentAddress & address, const SaplingOutPoint & entry);
    ...
    void GetFilteredNotes(std::vector<SproutNoteEntry>& sproutEntries,
                          std::vector<SaplingNoteEntry>& saplingEntries,
                          std::set<libzclassic::PaymentAddress>& filterAddresses,
                          int minDepth=1,
...
public:
    ...
    bool operator()(const libzclassic::SproutPaymentAddress &zaddr) const;
    bool operator()(const libzclassic::SaplingPaymentAddress &zaddr) const;
    bool operator()(const libzclassic::InvalidEncoding& no) const;
};
...
class GetSpendingKeyForPaymentAddress : public boost::static_visitor<boost::optional<libzclassic::SpendingKey>>
{
private:
    CWallet *m_wallet;
public:
    ...
    boost::optional<libzclassic::SpendingKey> operator()(const libzclassic::SproutPaymentAddress &zaddr) const;
    boost::optional<libzclassic::SpendingKey> operator()(const libzclassic::SaplingPaymentAddress &zaddr) const;
    boost::optional<libzclassic::SpendingKey> operator()(const libzclassic::InvalidEncoding& no) const;
};
...
public: 
    ...
    SpendingKeyAddResult operator()(const libzclassic::SproutSpendingKey &sk) const;
    SpendingKeyAddResult operator()(const libzclassic::SaplingExtendedSpendingKey &sk) const;
    SpendingKeyAddResult operator()(const libzclassic::InvalidEncoding& no) const;    
};
