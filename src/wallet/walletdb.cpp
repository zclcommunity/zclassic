...
bool CWalletDB::WriteCryptedZKey(const libzclassic::SproutPaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libzclassic::SproutPaymentAddress& addr, const libzclassic::SproutSpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteSaplingZKey(const libzclassic::SaplingIncomingViewingKey &ivk,
...
bool CWalletDB::WriteSproutViewingKey(const libzclassic::SproutViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseSproutViewingKey(const libzclassic::SproutViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libzclassic::SproutViewingKey vk;
            ssKey >> vk;
            char fYes;
            ssValue >> fYes;
            if (fYes == '1')
        ...
        {
            libzclassic::SproutPaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "sapzkey")
        {
            ...
            ssKey >> ivk;
            libzclassic::SaplingExtendedSpendingKey key;
            ssValue >> key;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libzclassic::ReceivingKey rk(rkValue);
        ...
        else if (strType == "csapzkey")
        {
            libzclassic::SaplingIncomingViewingKey ivk;
            ssKey >> ivk;
            libzclassic::SaplingExtendedFullViewingKey extfvk;
            ssValue >> extfvk;
            vector<unsigned char> vchCryptedSecret;
            ssValue >> vchCryptedSecret;
            wss.nCKeys++;
        ...
        {
            libzclassic::SaplingPaymentAddress addr;
            ssKey >> addr;
            libzclassic::SaplingIncomingViewingKey ivk;
            ssValue >> ivk;
