...
bool ShieldToAddress::operator()(const libzclassic::SproutPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libzclassic::SaplingPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libzclassic::InvalidEncoding& no) const {
    return false;
}
