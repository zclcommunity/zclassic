...
CWalletTx GetValidSproutReceive(const libzclassic::SproutSpendingKey& sk, CAmount value, bool randomInputs, int32_t version = 2) {
    return GetValidSproutReceive(*params, sk, value, randomInputs, version);
}

CWalletTx GetInvalidCommitmentSproutReceive(const libzclassic::SproutSpendingKey& sk, CAmount value, bool randomInputs, int32_t version = 2) {
    return GetInvalidCommitmentSproutReceive(*params, sk, value, randomInputs, version);
}

libzclassic::SproutNote GetSproutNote(const libzclassic::SproutSpendingKey& sk,
                       const CTransaction& tx, size_t js, size_t n) {
    return GetSproutNote(*params, sk, tx, js, n);
}

CWalletTx GetValidSproutSpend(const libzclassic::SproutSpendingKey& sk,
                        const libzclassic::SproutNote& note, CAmount value) {
...
TEST(WalletTests, SproutNoteDataSerialisation) {
    auto sk = libzclassic::SproutSpendingKey::random();
...
TEST(WalletTests, SetSaplingNoteAddrsInCWalletTx) {
    ...
    libzclassic::SaplingNote note(pk, 50000);
    auto cm = note.cm().get();
...
TEST(WalletTests, CheckSproutNoteCommitmentAgainstNotePlaintext) {
    ...
    ASSERT_THROW(wallet.GetSproutNoteNullifier(
        ...
        address,
        dec,
        hSig, 1), libzclassic::note_decryption_failed);
}
...
TEST(WalletTests, FindMySproutNotes) {
    ...
    auto sk = libzclassic::SproutSpendingKey::random();
    auto sk2 = libzclassic::SproutSpendingKey::random();
...
TEST(WalletTests, GetConflictedSaplingNotes) {
    ...
    auto maybe_pt = libzclassic::SaplingNotePlaintext::decrypt(
...
TEST(WalletTests, SetBestChainIgnoresTxsWithoutShieldedData) {
    ...
    mtxSapling.vShieldedOutput[0].cv = libzclassic::random_uint256();
    ...
    mtxSaplingTransparent.vShieldedOutput[0].cv = libzclassic::random_uint256();
...
TEST(WalletTests, MarkAffectedSaplingTransactionsDirty) {
    ...
    // 0.0005 t-ZCL in, 0.0004 z-ZCL out, 0.0001 t-ZCL fee
    ...
    // 0.0004 z-ZCL in, 0.00025 z-ZCL out, 0.0001 t-ZCL fee, 0.00005 z-ZCL change
    auto builder2 = TransactionBuilder(consensusParams, 2, expiryDelta);
