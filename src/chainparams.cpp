 ...
 * >>> 'Zclassic' + blake2s(b'The Economist 2016-10-29 Known unknown: Another crypto-currency is born. BTC#436254 0000000000000000044f321997f336d2908cf8c8d6893e88dbf067e2d949487d ETH#2521903 483039a6b6bd8bd05f0584f9a078d075e454925eb71c1f13eaff59b405a721bb DJIA close on 27 Oct 2016: 18,169.68').hexdigest()
 *
...
public:
    CMainParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("zclcore.org", "dnsseed.zclassic-ce.org"));
        vSeeds.push_back(CDNSSeedData("zcl.community", "dnsseed.zcl.community"));
        vSeeds.push_back(CDNSSeedData("zclassic.dev", "dnsseed.zclassic.dev"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("zclcore.org", "dnsseed.testnet.zclassic-ce.org"));
        vSeeds.push_back(CDNSSeedData("zcl.community", "dnsseed.testnet.zcl.community"));
        vSeeds.push_back(CDNSSeedData("zclassic.dev", "dnsseed.testnet.zclassic.dev"));
