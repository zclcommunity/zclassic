...
bool CBasicKeyStore::AddSproutSpendingKey(const libzclassic::SproutSpendingKey &sk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::AddSproutViewingKey(const libzclassic::SproutViewingKey &vk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::RemoveSproutViewingKey(const libzclassic::SproutViewingKey &vk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::HaveSproutViewingKey(const libzclassic::SproutPaymentAddress &address) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSproutViewingKeys.count(address) > 0;
}

bool CBasicKeyStore::HaveSaplingFullViewingKey(const libzclassic::SaplingIncomingViewingKey &ivk) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSaplingFullViewingKeys.count(ivk) > 0;
}

bool CBasicKeyStore::HaveSaplingIncomingViewingKey(const libzclassic::SaplingPaymentAddress &addr) const
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::GetSaplingFullViewingKey(const libzclassic::SaplingIncomingViewingKey &ivk,
...
bool CBasicKeyStore::GetSaplingIncomingViewingKey(const libzclassic::SaplingPaymentAddress &addr,
...
bool CBasicKeyStore::GetSaplingExtendedSpendingKey(const libzclassic::SaplingPaymentAddress &addr, 
