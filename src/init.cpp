...
ZCJoinSplit* pzclassicParams = NULL;
...
void Shutdown()
{
    ...
    pwalletMain = NULL;
#endif
    delete pzclassicParams;
    pzclassicParams = NULL;
...
)
{
    ...
    pzclassicParams = ZCJoinSplit::Prepared(vk_path.string(), pk_path.string());
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (mapArgs.count("-migrationdestaddress")) {
        ...
        libzclassic::PaymentAddress address = DecodePaymentAddress(migrationDestAddress);
        if (boost::get<libzclassic::SaplingPaymentAddress>(&address) == nullptr) {
    ...
    if (GetBoolArg("-savesproutr1cs", false)) {
        ...
        pzclassicParams->saveR1CS(r1cs_path.string());
    }
