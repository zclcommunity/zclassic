...
{
    std::array<libzclassic::SproutNote, ZC_NUM_JS_OUTPUTS> notes;
...
public:
    ...
    bool operator()(const libzclassic::PHGRProof& proof) const
    {
    ...
    bool operator()(const libzclassic::GrothProof& proof) const
    {
