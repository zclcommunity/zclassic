/*
See the Zclassic protocol specification for more information.
https://github.com/zclassic/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libzclassic::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libzclassic::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libzclassic::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
