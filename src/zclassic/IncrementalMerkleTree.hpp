...
#include "Zclassic.h"
#include "zclassic/util.h"

namespace libzclassic {
...
} // end namespace `libzclassic`

typedef libzclassic::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libzclassic::SHA256Compress> SproutMerkleTree;
typedef libzclassic::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzclassic::SHA256Compress> SproutTestingMerkleTree;

typedef libzclassic::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libzclassic::SHA256Compress> SproutWitness;
typedef libzclassic::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzclassic::SHA256Compress> SproutTestingWitness;

typedef libzclassic::IncrementalMerkleTree<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libzclassic::PedersenHash> SaplingMerkleTree;
typedef libzclassic::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzclassic::PedersenHash> SaplingTestingMerkleTree;

typedef libzclassic::IncrementalWitness<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libzclassic::PedersenHash> SaplingWitness;
typedef libzclassic::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzclassic::PedersenHash> SaplingTestingWitness;
