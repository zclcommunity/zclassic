#!/usr/bin/env python
# Copyright (c) 2019 The Zclassic developers
...
# 4. Restart zclassicd, enabling experimental feature -developersetpoolsizezero
# 5. Unshield funds
# 6. Wait for transaction to be mined (using testnet explorer or another node)
# 7. Verify zclassicd rejected the block
#
