...
class TxExpiringSoonTest(BitcoinTestFramework):
    ...
    def verify_inv(self, testnode, tx):
        ...
        # Send p2p message "mempool" to receive contents from zclassicd node in "inv" message
        with mininode_lock:
    ...
    def run_test(self):
        ...
        # Verify mininodes are connected to zclassicd nodes
        ...
        # Mininodes send expiring soon transaction in "tx" message to zclassicd node
        ...
        # Mininodes send transaction in "tx" message to zclassicd node
